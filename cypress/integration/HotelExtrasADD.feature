Feature: Adicionar Extras em hoteis
    ...
    Scenario Outline: Criar um Extra com preco negativo
        ...
        Examples:
            | nome        | status | preco  |  imagem                                                                                                                |
            | Vila Gale   | Sim    | -9999  | https://magazine.zarpo.com.br/wp-content/uploads/2018/10/conheca-os-9-hoteis-e-resorts-da-rede-vila-gale-no-brasil.jpg |
            | Hotel Paris | Nao    | -56851 | https://elysees-paris-hotel.com/_novaimg/4394833-1366277_200_0_1917_1533_1000_800.jpg                                  |
    ...
    Scenario Outline: Criar um Extra com textos de tamanho indefinido
        ...
        Examples:
            | nome                                         | status | preco                                                                                    | imagem |
            | TesteTesteTesteTesteTesteTesteTestTesteTeste | Sim    | 1582488581241373716715751798187137385671951978127819855713739517071107127875157107517785 | aaaaaa |
